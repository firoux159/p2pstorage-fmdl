...
public class P2PNodeServerBuilder extends NettyKademliaDHTNodeBuilder<String, FileDTO> {
	
	private int virtualNodeCount = 0;
	
	public P2PNodeServerBuilder(BigInteger id, NettyConnectionInfo connectionInfo, FileRepository repository, 
	...
	@Override
	public P2PNodeServer build() {
        fillDefaults();
        return new P2PNodeServer(buildDHTKademliaNodeAPI(), getKademliaNodeServer());
    }
...
//			this.nodeSettings(NodeSettings.Default.build());
    ...
    public P2PNodeServerBuilder messageSender(MessageSender<BigInteger, NettyConnectionInfo> messageSender){
    	super.messageSender(messageSender);
        return this;
    }
	
	public P2PNodeServerBuilder dhtStoreServiceFactory(DHTStoreServiceFactory<BigInteger, NettyConnectionInfo, String, FileDTO> dhtStoreServiceFactory){
    	super.dhtStoreServiceFactory(dhtStoreServiceFactory);
        return this;
    }

    public P2PNodeServerBuilder dhtLookupServiceFactory(DHTLookupServiceFactory<BigInteger, NettyConnectionInfo, String, FileDTO> dhtLookupServiceFactory) {
